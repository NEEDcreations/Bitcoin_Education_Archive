...
const SCHOLAR_PROPERTIES_POOL = [
  ...
  {
    "q": "What is the 'Genesis Block'?",
    "a": "The first block in the Bitcoin blockchain, containing a symbolic message about bank bailouts.",
    "w": [
      "The block that will be mined in 2140 to complete the 21 million supply.",
      "A specialized hardware device that Satoshi Nakamoto used to mine Bitcoin.",
      "The name of the folder where the Bitcoin Core source code is stored.",
      "A temporary block used to test the Lightning Network before it went live."
    ]
  },
  {
...
const SCHOLAR_TECHNICAL_POOL = [
  ...
  },
  {
    ...
    "w": [
      ...
      "It is a setting that allows a node to mine Bitcoin without having to solve the proof-of-work puzzle for each new block"
    ]
  },
  {
  ...
  },
  {
    ...
    "w": [
      ...
      "Solving a complex math problem that was created by Satoshi Nakamoto to prove you are a legitimate node"
    ]
  },
  {
