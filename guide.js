    ...
    window.showGuide = function() {
        ...
        sheet.innerHTML =
            ...
            guideSection('🔓 Apps to Explore', [
                ...
                guideCard('💬', 'rgba(59,130,246,0.12)', 'PlebTalk Forum', 'Community discussion board for Bitcoin topics and debates.', null, null, "sessionStorage.setItem('btc_return_guide','1');showGuideReturnBtn();minimizeGuide();setTimeout(function(){go('forum')},300)"),
