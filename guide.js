    ...
    window.showGuide = function() {
        ...
        sheet.innerHTML =
            ...
            guideSection('🎯 Daily Activities', [
                ...
                guideCard('❓', 'rgba(234,179,8,0.12)', 'Daily Quests', 'Test your Bitcoin knowledge with daily quizzes and earn bonus points.', 'tag-earn', '+Bonus points', "sessionStorage.setItem('btc_return_guide','1');showGuideReturnBtn();minimizeGuide();setTimeout(function(){if(typeof showDailyQuiz==='function')showDailyQuiz()},300)"),
            ...
            '<div style="margin-bottom:12px;">' +
                ...
                unlockTier('📺', 'Timechain TV', '21 channels of curated Bitcoin video content.', false, "sessionStorage.setItem('btc_return_guide','1');showGuideReturnBtn();minimizeGuide();setTimeout(function(){if(typeof go==='function'){go('timechain-tv')}},300)") +
                unlockTier('🦌', 'AI Nacho Mode', 'Your Bitcoin-savvy AI tutor powered by archive knowledge.', false, "sessionStorage.setItem('btc_return_guide','1');showGuideReturnBtn();minimizeGuide();setTimeout(function(){if(typeof toggleNachoMode==='function')toggleNachoMode()},300)") +
                unlockTier('⚔️', 'PVP Battles', 'Real-time 1v1 Bitcoin trivia battles against other players.', false, "sessionStorage.setItem('btc_return_guide','1');showGuideReturnBtn();minimizeGuide();setTimeout(function(){if(typeof enterPVPMode==='function')enterPVPMode()},300)") +
                unlockTier('🎵', 'Bitcoin Beats', 'Community music player with uploads, likes, and artist pages.', false, "sessionStorage.setItem('btc_return_guide','1');showGuideReturnBtn();minimizeGuide();setTimeout(function(){go('bitcoin-beats')},300)") +
                unlockTier('💬', 'PlebTalk Forum', 'Community discussion board for Bitcoin topics and debates.', false, "sessionStorage.setItem('btc_return_guide','1');showGuideReturnBtn();minimizeGuide();setTimeout(function(){go('forum')},300)") +
                unlockTier('🤝', 'IRL Sync', 'Find and organize real-life Bitcoin meetups near you.', false, "sessionStorage.setItem('btc_return_guide','1');showGuideReturnBtn();minimizeGuide();setTimeout(function(){go('irl-sync')},300)") +
                unlockTier('🛒', 'Lightning Mart', 'Buy and sell goods using Lightning payments.', false, "sessionStorage.setItem('btc_return_guide','1');showGuideReturnBtn();minimizeGuide();setTimeout(function(){go('marketplace')},300)") +
            '</div>' +
