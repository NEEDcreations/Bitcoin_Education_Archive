var TRIVIA_BANK = [
    ...
    },
    {
        ...
        options: ["Burned", "Permanently staked", "Vault locked", "Protocol bonded"],
        answer: 0,
    ...
    },
    {
        ...
        options: ["Nick Szabo", "Satoshi Nakamoto", "David Chaum", "Hal Finney Jr."],
        answer: 0,
    ...
    },
    {
        ...
        options: ["Saifedean Ammous", "Andreas Antonopoulos", "Jameson Lopp, Jr.", "Michael J. Saylor"],
        answer: 0,
    ...
    },
    {
        ...
        options: ["Bitcoin Pizza Day (May 22)", "Genesis Day", "Bitcoin Freedom Celebration Day (August 1)", "Bitcoin Halving Day"],
        answer: 0,
    ...
    },
    {
        ...
        options: ["A payment channel", "A shared mining operation pool", "A dedicated smart contract address", "An independent Bitcoin sidechain connection"],
        answer: 0,
    ...
    },
    {
        ...
        options: ["Satoshis (sats)", "Millisatoshis or msats", "Whole Bitcoin units only", "Special Lightning network credits"],
        answer: 0,
    ...
    },
    {
        ...
        options: ["LND", "Core Lightning (CLN)", "The Eclair implementation", "Electrum Lightning Extension"],
        answer: 0,
    ...
    // ===== CURRENT EVENTS & ADOPTION (14 questions) =====
    {
        ...
        options: ["El Salvador", "The Republic of Paraguay", "The nation of Panama", "Central American Honduras"],
        answer: 0,
    ...
    },
    {
        ...
        options: ["Chivo", "Muun Wallet", "BlueWallet Lightning", "Strike Global"],
        answer: 0,
    ...
    },
    {
        ...
        options: ["MicroStrategy", "Tesla Motors Inc", "Block (formerly Square)", "Galaxy Digital Holdings"],
        answer: 0,
    ...
    },
    {
        ...
        options: ["Tesla", "Rivian Automotive", "Lucid Motors Group", "NIO Electric Vehicles"],
        answer: 0,
    ...
    },
    {
        ...
        options: ["Nigeria", "East African Kenya", "Republic of South Africa", "West African Ghana"],
        answer: 0,
    ...
    },
    {
        ...
        options: ["PayPal", "Venmo Mobile Payments", "Stripe Payment Processing", "Zelle Bank Transfers"],
        answer: 0,
