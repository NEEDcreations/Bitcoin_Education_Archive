var TRIVIA_BANK = [
  ...
  },
  {
    ...
    "options": [
      ...
      "An acronym coined by Satoshi Nakamoto in the whitepaper",
      "A Wall Street trading strategy adapted for crypto",
      "A meme that first appeared on Reddit in early 2015"
    ],
    "answer": 0,
  ...
  },
  {
    ...
    "options": [
      ...
      "They are a Bitcoin Core developer who has contributed code to the protocol",
      "They run a large-scale Bitcoin mining operation using proof-of-work hardware",
      "They have completed an on-chain identity verification through a smart contract"
    ],
    "answer": 0,
  ...
  },
  {
    ...
    "options": [
      ...
      "A person who owns the maximum possible amount of Bitcoin in a single wallet",
      "A miner running the most powerful hardware available for proof of work",
      "A developer who has contributed the most lines of code to Bitcoin Core software"
    ],
    "answer": 0,
  ...
  },
  {
    ...
    "options": [
      ...
      "A proposed technical improvement to increase Bitcoin transaction throughput speed",
      "An algorithm designed to automatically increase the mining difficulty over time",
      "A data compression method for reducing the size of the blockchain on full nodes"
    ],
    "answer": 0,
  ...
  },
  {
    ...
    "options": [
      ...
      "Building a physical stack of ASIC mining rigs for profit",
      "Organizing satellite nodes for the Bitcoin network",
      "Compiling and organizing Bitcoin transaction data locally"
    ],
    "answer": 0,
  ...
  },
  {
    ...
    "options": [
      ...
      "A type of ultra-secure cold storage Bitcoin vault system with multisig protection",
      "The rumored physical headquarters of the anonymous Bitcoin Foundation leadership",
      "A well-known cooperative Bitcoin mining pool that early adopters frequently joined"
    ],
    "answer": 0,
  ...
  },
  {
    ...
    "options": [
      ...
      "Future Unlimited Digital Dividends",
  ...
  },
  {
    ...
    "options": [
      ...
      "A full node operator running the Bitcoin Core software",
  ...
  },
  {
    ...
    "options": [
      ...
      "Genesis Day",
      "Bitcoin Freedom Celebration Day (August 1)",
      "Bitcoin Halving Day"
    ],
    "answer": 0,
  ...
  },
  {
    ...
    "options": [
      "A payment channel",
      "A shared mining operation pool",
      "A dedicated smart contract address",
      "An independent Bitcoin sidechain connection"
    ],
    "answer": 0,
  ...
  },
  {
    ...
    "options": [
      ...
      "Nakamoto and Finney",
      "Gregory Maxwell and Adam Back together",
      "Elizabeth Stark with Olaoluwa Osuntokun"
    ],
    "answer": 0,
  ...
  },
  {
    ...
    "options": [
      "Segregated Witness (SegWit)",
      "The Taproot soft fork upgrade",
      "Bitcoin's Replace-by-Fee transaction mechanism",
      "The OP_RETURN data embedding function"
    ],
    "answer": 0,
  ...
  },
  {
    ...
    "options": [
      ...
      "Every individual transaction from the channel is permanently recorded on-chain in full detail",
      "All locked funds are completely destroyed and then freshly re-minted as new coins",
      "It reopens"
    ],
    "answer": 0,
  ...
  },
  {
    ...
    "options": [
      ...
      "The total bandwidth and speed capacity of a Lightning node's dedicated internet connection",
      "How many simultaneous channels one node opens"
    ],
    "answer": 0,
  ...
  },
  {
    ...
    "options": [
      ...
      "Enhanced full nodes",
      "A mandatory government-run surveillance tool used for actively monitoring and tracking all Bitcoin transactions on the public network",
      "A node that validates Lightning invoices"
    ],
    "answer": 0,
  ...
  },
  {
    ...
    "options": [
      "Satoshis (sats)",
      "Millisatoshis or msats",
      "Whole Bitcoin units only",
      "Special Lightning network credits"
    ],
    "answer": 0,
  ...
  },
  {
    ...
    "options": [
      "LND",
      "Core Lightning (CLN)",
      "The Eclair implementation",
      "Electrum Lightning Extension"
    ],
    "answer": 0,
  ...
  },
  {
    ...
    "options": [
      ...
      "Cross-blockchain token swapping",
      "A privacy method for concealing Lightning payment amounts from observers",
      "A technique for merging channels together"
    ],
    "answer": 0,
  ...
  },
  {
    ...
    "options": [
      ...
      "Off-chain Ledger Technology",
      "A popular and widely-used mobile wallet application designed for everyday Lightning payments",
      "Binary Optimized Lightning Transfer protocol specifications"
    ],
    "answer": 0,
  ...
  },
  {
    ...
    "options": [
      ...
      "Miner-signed transactions",
      "The requirement for multiple blockchain confirmations before considering a transaction valid",
      "A multi-cryptocurrency wallet supporting various coins"
    ],
    "answer": 0,
  ...
  },
  {
    ...
    "options": [
      ...
      "Wallet merging protocol",
      "A standard protocol used for joining and coordinating mining pools together",
      "Consolidating multiple UTXOs into a single output"
    ],
    "answer": 0,
  ...
  },
  {
    ...
    "options": [
      ...
      "A dedicated full-node computer",
      "A specialized USB drive that contains a fully complete and synchronized copy of the entire Bitcoin blockchain",
      "Specialized mining rig hardware"
    ],
    "answer": 0,
  ...
  },
  {
    ...
    "options": [
      ...
      "Simultaneously stealing very small fractional amounts from thousands of different wallets at once",
      "Mining intentionally empty blocks to slow network"
    ],
    "answer": 0,
  ...
  },
  {
    ...
    "options": [
      ...
      "SegWit format",
      "The Lightning Network's standardized routing and payment channel protocol specification document",
      "Bitcoin's mining difficulty adjustment algorithm"
    ],
    "answer": 0,
  ...
  },
  {
    ...
    "options": [
      ...
      "A tool for monitoring the full mempool for any specific pending transaction activity",
      "Watching other users' blockchain activity"
    ],
    "answer": 0,
  ...
  },
  {
    ...
    "options": [
      ...
      "Address expiration",
      "It significantly and noticeably increases the transaction fees that are charged by the entire Bitcoin network",
      "It directly violates Bitcoin protocol rules"
    ],
    "answer": 0,
  ...
  },
  {
    ...
    "options": [
      ...
      "AI-powered trading wallet",
      "A wallet securely stored and distributed across multiple cloud-based neural network infrastructure systems worldwide",
      "Quantum-resistant wallet design"
    ],
    "answer": 0,
  ...
  },
  {
    ...
    "options": [
      ...
      "Standardized Bitcoin options trading contracts",
      "Government-backed Bitcoin savings bonds"
    ],
    "answer": 0,
  ...
  },
  {
    ...
    "options": [
      ...
      "E-waste",
      "Excessive industrial water usage needed for cooling large mining facility operations",
      "Deforestation to build mining farms"
    ],
    "answer": 0,
  ...
  },
  {
    ...
    "options": [
      ...
      "Government mining regulator",
      "An official centralized government organization that directly allocates and controls Bitcoin mining difficulty adjustment settings",
      "A consortium controlling Bitcoin hash rate"
    ],
    "answer": 0,
  ...
  },
  {
    ...
    "options": [
      ...
      "Cash App exchange",
      "A specialized bridge technology connecting Ethereum transactions to Bitcoin's blockchain network",
      "A proprietary forked Bitcoin blockchain"
    ],
    "answer": 0,
  ...
  },
  {
    ...
    "options": [
      ...
      "Hydroelectric mining dam",
      "A large dedicated solar-powered cryptocurrency mining farm operation built in the desert",
      "A wind operation"
    ],
    "answer": 0,
  ...
  },
  {
    ...
    "options": [
      ...
      "Interest-in-Bitcoin corporate bond",
      "A bond instrument that automatically converts its full face value to Bitcoin at maturity",
      "A decentralized finance lending instrument"
    ],
    "answer": 0,
  ...
  },
  {
    ...
    "options": [
      ...
      "Social media HODL tracking",
      "A chart measuring the precise frequency and intensity of price volatility during market cycles",
      "New wallet creation trends over time"
    ],
    "answer": 0,
  ...
  {
    "q": "How many Bitcoin did Laszlo Hanyecz pay for two Papa John's pizzas on May 22, 2010?",
    "options": [
      "10,000 BTC",
      "1,000 BTC",
      "50,000 BTC",
    ...
    "answer": 0,
    "explanation": "Laszlo Hanyecz paid 10,000 BTC for two pizzas — the first known commercial Bitcoin transaction. May 22 is now celebrated as Bitcoin Pizza Day."
  },
  {
    "q": "What date is celebrated as Bitcoin Pizza Day?",
    "options": [
      "May 22",
      "January 3",
      "October 31",
    ...
    "answer": 0,
    "explanation": "May 22, 2010 — the day Laszlo Hanyecz completed the first known commercial Bitcoin transaction: 10,000 BTC for two pizzas."
  },
  {
    "q": "What was the very first price of Bitcoin, calculated by the cost of electricity to produce one coin?",
    "options": [
      "$0.000994",
      "$0.01",
      "$0.0000014",
    ...
    "answer": 0,
    "explanation": "Bitcoin's first price of $0.000994 was calculated by measuring the value of electricity needed to produce one Bitcoin at the time, as documented in The Bitcoin Standard."
  },
  {
    "q": "El Salvador became the first nation to make Bitcoin legal tender. In what year?",
    "options": [
      "2021",
      "2019",
      "2023",
    ...
    "answer": 0,
    "explanation": "In June 2021, El Salvador under President Nayib Bukele became the first nation in the world to make Bitcoin legal tender."
  },
  {
    "q": "What was unusual about the Bitcoin genesis block's 50 BTC reward?",
    "options": [
      "It cannot be spent due to a quirk in the protocol",
      "It was immediately sent to Hal Finney",
      "It was mined by accident with no difficulty target",
      "It was double the normal block reward"
    ],
    "answer": 0,
    "explanation": "The protocol requires that the 50 BTC in block 0 (the genesis block) cannot be transferred — they are effectively unspendable and do not count toward the circulating supply."
  },
  {
    "q": "How long did it take Satoshi to mine the Bitcoin genesis block on a single CPU?",
    "options": [
      "6 days",
      "10 minutes",
      "24 hours",
    ...
    "answer": 0,
    "explanation": "While the expected time was about 7 days, Satoshi mined the Genesis Block in approximately 5.81 days — getting four leading zeros by chance at the lowest difficulty."
  },
  {
    "q": "What famous headline did Satoshi embed in the Bitcoin genesis block?",
    "options": [
      "The Times 03/Jan/2009 Chancellor on brink of second bailout for banks",
      "Wall Street Journal: Federal Reserve Cuts Rates to Zero",
      "New York Times: Economy in Worst Decline Since Depression",
      "Financial Times: Bank of England Raises Emergency Funds"
    ],
    "answer": 0,
    "explanation": "Satoshi embedded this Times headline as both a timestamp and a political statement about the broken banking system that Bitcoin was designed to replace."
  },
  {
    "q": "Who received the very first Bitcoin transaction from Satoshi Nakamoto?",
    "options": [
      "Hal Finney",
      "Nick Szabo",
      "Adam Back",
    ...
    "answer": 0,
    "explanation": "The first Bitcoin transaction was sent from Satoshi to Hal Finney on January 11, 2009, mined in block 170. All previous 169 blocks contained no transactions."
  },
  {
    "q": "Approximately how many lines of code did Satoshi write to create Bitcoin?",
    "options": [
      "31,000–32,000 lines",
      "1,000 lines",
      "100,000 lines",
    ...
    "answer": 0,
    "explanation": "Satoshi wrote approximately 31,000–32,000 lines of code for the original Bitcoin implementation, as documented in a 2011 magazine article and later analysis."
  },
  {
    "q": "Today, only what percentage of Bitcoin Core's code remains unchanged from Satoshi's original?",
    "options": [
      "0.06%",
      "10%",
      "50%",
    ...
    "answer": 0,
    "explanation": "Over time, almost all of Satoshi's original code has been replaced. Only 0.06% of lines in the Bitcoin Core repository remain unchanged from when Satoshi wrote them — we are all Satoshi!"
  },
  {
    "q": "How many confirmations must newly mined Bitcoin wait before it can be spent?",
    "options": [
      "101 confirmations",
      "1 confirmation",
      "6 confirmations",
    ...
    "answer": 0,
    "explanation": "Mined (coinbase) Bitcoin cannot be spent until it has 101 confirmations — roughly 16+ hours. This prevents issues if an early block gets orphaned."
  },
  {
    "q": "What is the default mempool size for a Bitcoin node?",
    "options": [
      "300 MB",
      "1 GB",
      "50 MB",
    ...
    "answer": 0,
    "explanation": "By default, a Bitcoin node allocates 300 MB for its mempool — the waiting area for unconfirmed transactions. This can be adjusted in the node's configuration file."
  },
  {
    "q": "How many nodes does a Bitcoin node connect to by default?",
    "options": [
      "10 other nodes",
      "100 nodes",
      "1 node",
    ...
    "answer": 0,
    "explanation": "By default, a Bitcoin node connects to 10 other nodes at any one time. This can be changed in the bitcoin.conf configuration file."
  },
  {
    "q": "When were BIP 39 seed phrases introduced?",
    "options": [
      "2013",
      "2009",
      "2017",
    ...
    "answer": 0,
    "explanation": "Seed phrases (BIP 39 mnemonics) only came into existence in 2013. Before that, Bitcoin wallets used different, less user-friendly backup methods."
  },
  {
    "q": "What is the maximum size of a single Bitcoin transaction that nodes will relay?",
    "options": [
      "100 KB",
      "1 MB",
      "4 MB",
    ...
    "answer": 0,
    "explanation": "100 KB is the maximum size of a single transaction that standard Bitcoin nodes will verify and relay across the network."
  },
  {
    "q": "What does the Bitcoin dust limit of 546 satoshis represent?",
    "options": [
      "The minimum amount sendable at 1 sat/byte before node relay rules reject it",
      "The smallest denomination used in Lightning Network channel balances",
      "The minimum fee required before a transaction broadcasts to the mempool",
      "The floor amount below which wallets automatically consolidate UTXOs"
    ],
    "answer": 0,
    "explanation": "546 satoshis is the dust limit — the smallest amount you can send at 1 sat/byte per standard node relay rules. Many wallets use this as their default dust threshold."
  },
  {
    "q": "What is the maximum difficulty adjustment allowed in a single Bitcoin difficulty epoch?",
    "options": [
      "+300% upward or -75% downward",
      "+100% or -50%",
      "+50% or -25%",
      "+1000% or -90%"
    ],
    "answer": 0,
    "explanation": "Bitcoin's difficulty adjustment is capped: it can increase by at most 300% (4x) or decrease by at most 75% (to 1/4) in a single 2016-block epoch — preventing runaway swings."
  },
  {
    "q": "How many rules does a Bitcoin miner check when validating a single transaction and block?",
    "options": [
      "30–40 rules each",
      "3–5 rules",
      "100+ rules",
    ...
    "answer": 0,
    "explanation": "When miners validate transactions, they check 30–40 individual rules for each transaction and another 30–40 rules for the block as a whole."
  },
  {
    "q": "Which Bitcoin address format starts with 'bc1p'?",
    "options": [
      "Taproot (SegWit v1)",
      "SegWit v0 (native segwit)",
      "Legacy P2PKH",
      "P2SH wrapped SegWit"
    ],
    "answer": 0,
    "explanation": "Taproot addresses start with bc1p — Taproot is SegWit version 1. SegWit version 0 addresses start with bc1q (the 'q' standing for version 0, since coders start counting at 0)."
  },
  {
    "q": "Under what conditions will a Bitcoin node reject a block header timestamp?",
    "options": [
      "If it's more than 2 hours in the future according to the node's clock",
      "If it's older than 10 minutes",
      "If it's in a different time zone than the majority of nodes",
      "If the timestamp doesn't match the previous block exactly"
    ],
    "answer": 0,
    "explanation": "Full nodes will not accept blocks with headers timestamped more than two hours in the future. Block timestamps must also be greater than the median of the previous 11 blocks."
  },
  {
    "q": "On August 15, 2010, a bug in Bitcoin created 184 billion BTC in a single transaction. What happened?",
    "options": [
      "The block was discovered, flagged, and the chain was rolled back in the largest reorg in Bitcoin history (53 blocks)",
      "Satoshi remotely invalidated the extra coins using a developer admin key embedded in the original code",
      "All extra coins were automatically routed to a known burn address encoded in Bitcoin's genesis parameters",
      "Miners voted over several days to orphan the block, but the extra coins remained as an unclaimed supply anomaly"
    ],
    "answer": 0,
    "explanation": "The value overflow bug in block 74,638 created 184,467,440,737 BTC. Within hours, developers patched the code and the community reorganized the chain — a 53-block reorg, still the largest in Bitcoin history."
  },
  {
    "q": "There is a known bug in Bitcoin that will cause the chain to halt in what year if not fixed?",
    "options": [
      "2106",
      "2140",
      "2999",
    ...
    "answer": 0,
    "explanation": "An overflow bug in Bitcoin's timestamp handling will cause the chain to halt in the year 2106. It's only fixable through a hard fork — something the community has plenty of time to plan."
  },
  {
    "q": "How many halvings are coded into Bitcoin's source code, even though new supply hits zero after just 33?",
    "options": [
      "64 halvings",
      "33 halvings",
      "21 halvings",
    ...
    "answer": 0,
    "explanation": "Bitcoin's source code technically encodes 64 halvings, even though the block reward effectively reaches 0 BTC after the 33rd halving. The extra 31 halvings are essentially vestigial code."
  },
  {
    "q": "When were ASICs first available for Bitcoin mining?",
    "options": [
      "2012, with Butterfly Labs' Jalapeno",
      "2009, when Bitcoin launched",
      "2015, after SegWit",
      "2017, with the block size wars"
    ],
    "answer": 0,
    "explanation": "One of the first ASICs available commercially was the Butterfly Labs Jalapeno in 2012 — a small USB-sized miner that marked the end of CPU and GPU mining dominance."
  },
  {
    "q": "A 2007 Intel Core 2 Extreme CPU had enough power to solo mine what portion of early Bitcoin?",
    "options": [
      "All of the Bitcoin mined in 2009",
      "Less than 1% of 2009 Bitcoin",
      "All Bitcoin mined in the first 4 years",
      "Only the genesis block"
    ],
    "answer": 0,
    "explanation": "A 2007 Intel Core 2 Extreme would have been able to solo mine all of the Bitcoin mined in the entire year of 2009 — showing how low the early difficulty was."
  },
  {
    "q": "Approximately how many calories of energy does it take to create 1 Bitcoin?",
    "options": [
      "314 billion calories",
      "1,000 calories",
      "1 million calories",
      "100 billion calories"
    ],
    "answer": 0,
    "explanation": "1 Bitcoin takes approximately 314 billion calories (or 1,001 billion Joules) of energy to create — a reflection of Bitcoin's proof-of-work security model."
  },
  {
    "q": "Approximately what percentage of Bitcoin's total supply will have been mined by 2035?",
    "options": [
      "99%",
      "50%",
      "75%",
    ...
    "answer": 0,
    "explanation": "By approximately 2035, around 99% of all Bitcoin will have been mined. The last Bitcoin won't be mined until around the year 2140 due to the halving schedule."
  },
  {
    "q": "How many posts did Satoshi Nakamoto make on the BitcoinTalk forums?",
    "options": [
      "575 posts",
      "21 posts",
      "10,000 posts",
    ...
    "answer": 0,
    "explanation": "Satoshi wrote exactly 575 posts on the BitcoinTalk forums before disappearing from public view in 2010, leaving the project 'in good hands with everyone.'"
  },
  {
    "q": "How many known Bitcoin addresses does Satoshi Nakamoto have?",
    "options": [
    ...
    "answer": 0,
    "explanation": "Satoshi had at least 22,000 documented addresses and likely never reused a single one — demonstrating early and consistent privacy hygiene."
  },
  {
    "q": "What does 'Satoshi' mean in Japanese?",
    "options": [
      "Awakening to truth, related to the Sanskrit word 'Sat'",
      "Digital money, derived from the Japanese word for electronic coin",
      "Hidden identity, a Japanese phrase for anonymous creator",
      "Sound foundation, from the Japanese architectural term for base structure"
    ],
    "answer": 0,
    "explanation": "Satoshi is a Japanese version of 'Satori' (awakening to truth), itself based on the Sanskrit word 'Sat' meaning truth or being. A fitting name for Bitcoin's creator."
  },
  {
    "q": "Satoshi registered which domain the day before bitcoin.org?",
    "options": [
      "netcoin.org",
      "digitalcash.org",
      "satoshicoin.org",
    ...
    "answer": 0,
    "explanation": "Satoshi registered netcoin.org the day before bitcoin.org — suggesting the project's name wasn't finalised until very late in development."
  },
  {
    "q": "What was the pre-release Bitcoin block time before Satoshi changed it to 10 minutes?",
    "options": [
      "15 minutes",
      "5 minutes",
      "1 minute",
    ...
    "answer": 0,
    "explanation": "The 2008 pre-release version of Bitcoin had 15-minute block times and a difficulty adjustment every 30 days. Satoshi changed both to 10-minute blocks and a 2-week adjustment before the January 2009 launch."
  },
  {
    "q": "What is the approximate probability of randomly guessing someone's Bitcoin private key?",
    "options": [
      "Roughly the same as winning Powerball 7 times in a row",
      "About 1 in 1 million",
      "About 1 in 1 billion",
      "The same as guessing a random 6-digit PIN"
    ],
    "answer": 0,
    "explanation": "The chance of guessing a Bitcoin private key is astronomically small — roughly equivalent to winning the Powerball lottery 7 times consecutively."
  },
  {
    "q": "The chance of a wallet generating an existing seed phrase is comparable to what?",
    "options": [
      "Selecting a specific atom from a grain of sand on one of Earth's beaches",
      "Guessing a random 6-digit pin code on the first try without any hints",
      "Winning the national lottery jackpot twice in back-to-back weekly draws",
      "Correctly predicting the outcome of 40 consecutive fair coin flips in a row"
    ],
    "answer": 0,
    "explanation": "The chance of generating an already-existing seed phrase is about the same as selecting a particular atom in a grain of sand (43 quintillion atoms per grain) from one of Earth's beaches — effectively impossible."
  },
  {
    "q": "To restore a Bitcoin wallet, how many letters of each seed word do you need at minimum?",
    "options": [
      "The first 4 letters of each word",
      "The full word spelled correctly",
      "Only the first letter",
      "At least 8 letters"
    ],
    "answer": 0,
    "explanation": "You only need the first 4 letters of each BIP 39 seed word to initiate a restore — the BIP 39 wordlist was designed so no two words share the same first 4 letters."
  },
  {
    "q": "How much more does it cost to spend from a 2-of-3 multisig compared to a single-sig transaction?",
    "options": [
      "About 1.5x more",
      "10x more",
      "The same cost",
    ...
    "answer": 0,
    "explanation": "It costs approximately 1.5x more to spend from a 2-of-3 multisig wallet than a standard single-signature transaction, due to the extra data required for multiple signatures."
  },
  {
    "q": "What is the median base fee on the Lightning Network?",
    "options": [
      "1 satoshi",
      "1,000 satoshis",
      "0 satoshis",
    ...
    "answer": 0,
    "explanation": "The median fee rate on the Lightning Network is a base fee of 1 satoshi plus a very small proportional fee rate — making Lightning payments nearly free for everyday amounts."
  },
  {
    "q": "Using SegWit, what is the theoretical maximum block size Bitcoin could scale to with just a soft fork?",
    "options": [
      "64 MB",
      "4 MB",
      "8 MB",
    ...
    "answer": 0,
    "explanation": "With the SegWit upgrade already in place, Bitcoin's block size could technically be increased to 64 MB through just a soft fork — though the community favors keeping blocks small to preserve decentralization."
  },
  {
    "q": "In what year did Bitcoin have no price at all?",
    "options": [
      "For the first ~10 months after launch (2009)",
      "2010, after Pizza Day",
      "2008, before launch",
      "Bitcoin always had a price"
    ],
    "answer": 0,
    "explanation": "Bitcoin had no price for approximately the first 10 months after its January 2009 launch. The first recorded price didn't appear until late 2009, when Satoshi himself made an early exchange."
  },
  {
    "q": "What was notable about the Overstock.com Bitcoin milestone in 2014?",
    "options": [
      "It was one of the first major national retailers to accept Bitcoin as payment",
      "It was the first company to put Bitcoin on its balance sheet",
      "It launched the first Bitcoin ETF",
      "It was the first company to pay employee salaries in Bitcoin"
    ],
    "answer": 0,
    "explanation": "Overstock.com became one of the first major national retailers to begin accepting Bitcoin as payment in 2014 — a milestone for mainstream Bitcoin commerce."
  },
  {
    "q": "What is the Bitcoin whitepaper encoded in on the blockchain?",
    "options": [
      "Block 230,009",
      "Block 1 (genesis)",
      "Block 21,000",
    ...
    "answer": 0,
    "explanation": "Bitcoin's original whitepaper is encoded in block 230,009 — a piece of Bitcoin history permanently inscribed on the timechain itself."
  },
  {
    "q": "The Bitcoin difficulty adjustment happens every how many blocks?",
    "options": [
      "2,016 blocks",
      "210,000 blocks",
      "144 blocks",
    ...
    "answer": 0,
    "explanation": "Bitcoin's difficulty adjusts every 2,016 blocks — approximately every 2 weeks — to ensure blocks continue to be found roughly every 10 minutes regardless of total hash rate."
  },
  {
    "q": "In Bitcoin lore, 2,016 (the difficulty epoch length) is the semordnilap of which famous Executive Order?",
    "options": [
      "Executive Order 6102, which forced Americans to sell their gold to the Federal Reserve",
      "Executive Order 9066, which authorized Japanese internment",
      "Executive Order 6,210, the first banking holiday decree",
      "Executive Order 2016, creating the Federal Open Market Committee"
    ],
    "answer": 0,
    "explanation": "Bitcoin difficulty adjusts every 2,016 blocks — the semordnilap (reverse) of 6,102, the Executive Order that forced Americans to hand over gold under threat of imprisonment."
  },
  {
    "q": "What famous event happened to a UK man's hard drive containing 7,500 Bitcoin?",
    "options": [
      "He accidentally threw it away and it is buried in a UK landfill — he has been fighting authorities to excavate it ever since",
      "It was stolen by hackers who remotely accessed a backup server and wiped the decryption keys from all devices",
      "It was seized by UK tax authorities during a cryptocurrency investigation and auctioned at a government surplus sale",
      "It was destroyed in a house fire along with printed seed backups — the Bitcoin is permanently unrecoverable"
    ],
    "answer": 0,
    "explanation": "James Howells of Wales accidentally discarded a hard drive containing 7,500 BTC, which ended up in a local landfill. His ongoing quest to excavate and recover it has become one of Bitcoin's most famous lost-coin stories."
  },
  {
    "q": "Bitcoin's original source code contained the beginning of what unexpected feature Satoshi never finished?",
    "options": [
      "A virtual poker game",
      "An in-wallet chat system",
      "A Bitcoin-based email client",
      "A price ticker with live exchange rates"
    ],
    "answer": 0,
    "explanation": "The original Bitcoin code includes the beginnings of a virtual poker game that Satoshi is believed to have started but never finished — a fascinating Easter egg in early Bitcoin history."
  },
  {
    "q": "In block 124,724, what happened to permanently remove 1 satoshi from Bitcoin's supply?",
    "options": [
      "Solo miner midnightmagic produced 49.99999999 BTC instead of 50, permanently removing 1 satoshi from Bitcoin's supply",
      "Satoshi intentionally burned exactly 1 satoshi from that block as a cryptographic proof-of-burn timestamp signature",
      "A fee rounding error in the transaction validation engine caused exactly 1 satoshi to be double-counted and voided",
      "A competing miner submitted an alternative block at the same height that orphaned 1 satoshi through a chain split"
    ],
    "answer": 0,
    "explanation": "User midnightmagic solo mined block 124,724 and produced 49.99999999 BTC instead of 50 — because the block subsidy is calculated by block height, not remaining supply. That 1 sat is gone forever, slightly reducing the total supply from 21 million."
  },
  {
    "q": "What happened to Bitcoin's network on the two occasions it went down in its history?",
    "options": [
      "Once for 8h 27m due to the value overflow bug (2010) and once for 6h 20m due to a database fork (2013)",
      "Once for 24 hours due to a DDoS attack and once for 48 hours due to a mining bug",
      "Once for 1 hour during the first halving and once for 2 hours during SegWit activation",
      "It has never gone down — Bitcoin has 100% uptime"
    ],
    "answer": 0,
    "explanation": "Bitcoin has experienced two notable outages: the 2010 value overflow incident (8h 27m) and a 2013 database compatibility issue (6h 20m). Both were resolved through community consensus to roll back blocks."
  },
  {
    "q": "Hal Finney created a video game in 1982 — what was it called?",
    "options": [
    ...
    "answer": 0,
    "explanation": "Before becoming one of Bitcoin's earliest contributors, Hal Finney created The Adventures of Tron in 1982 — a game for the Atari 2600. Hal also wrote about NFT-like concepts in 1993, decades before they became mainstream."
  },
  {
    "q": "The 1991 video game Space Quest IV featured a currency that eerily resembled what?",
    "options": [
      "Bitcoin's ₿ symbol",
    ...
    "answer": 0,
    "explanation": "Space Quest IV: Roger Wilco and the Time Rippers (1991) featured a currency called the 'Buckazoid' — with a symbol strikingly similar to Bitcoin's ₿ logo, more than a decade before Bitcoin existed."
  },
  {
    "q": "According to Nikola Tesla, numbers 3, 6, and 9 are the keys to the universe. How do Bitcoiners map these to Bitcoin?",
    "options": [
      "21M coins → 2+1+0...=3, 33 halvings → 3+3=6, difficulty every 2,016 blocks → 2+0+1+6=9",
      "21M → 2×1=2, then 2+halving_count=3; 6 confirmations for finality; block height 9 in genesis era",
      "3 Bitcoin price cycles to date, 6 confirmed Satoshi email addresses found, 9 known core developers",
      "Block reward 3.125 BTC, difficulty target with 6 leading zeros minimum, 9 years for 90% supply mined"
    ],
    "answer": 0,
    "explanation": "The Bitcoin–Tesla numerology: 21,000,000 coins → 2+1+0...=3; 33 halvings → 3+3=6; difficulty adjustment every 2,016 blocks → 2+0+1+6=9. All three of Tesla's special numbers encoded in Bitcoin's design."
  },
  {
    "q": "What anomaly did an object called GPM J1839-10 contribute to Bitcoin lore?",
    "options": [
      "It blinks every 21 minutes and has done so since 1988 — dubbed the 'Star of Satoshi-hem'",
      "It was named after Satoshi Nakamoto by an astronomer",
      "It emits radio waves in patterns matching Bitcoin's block time",
      "It was discovered on October 31, the day the whitepaper was published"
    ],
    "answer": 0,
    "explanation": "GPM J1839-10 is a star-like object that has been blinking every 21 minutes since 1988 — long before Bitcoin. Some Bitcoiners call it the 'Star of Satoshi-hem,' noting the curious connection to the 21 million supply cap."
  },
  {
    "q": "How long can Bitcoin transactions be timelocked into the future using Bitcoin's technical maximum?",
    "options": [
      "Approximately 9,000 years",
      "Until the year 2140",
      "100 years maximum",
      "Until block 21,000,000"
    ],
    "answer": 0,
    "explanation": "Using Bitcoin's CLTV (CheckLockTimeVerify) opcode with the maximum timestamp value, funds can technically be timelocked for approximately 9,000 years into the future."
  },
  {
    "q": "In numerology, what number is the sum of Bitcoin's 2+1+6 (difficulty epoch length)?",
    "options": [
      "9",
      "3",
      "6",
    ...
    "answer": 0,
    "explanation": "The difficulty adjustment epoch of 2,016 blocks: 2+0+1+6=9. Nikola Tesla claimed 3, 6, and 9 are the keys to the universe — all three appear directly in Bitcoin's core parameters."
  },
  {
    "q": "How many approximately 300–400 byte transactions fit into a 1 MB Bitcoin block?",
    "options": [
      "3,000–4,000 transactions",
      "100 transactions",
      "10,000 transactions",
      "1,000 transactions"
    ],
    "answer": 0,
    "explanation": "A Bitcoin transaction is typically 300–400 bytes. With 1,000,000 bytes in a megabyte, a 1 MB base block can fit roughly 3,000–4,000 standard transactions."
  },
  {
    "q": "What is the average number of transactions per second Bitcoin has achieved across its lifetime?",
    "options": [
      "Fewer than 10 TPS on the base layer",
      "Over 1,000 TPS",
      "Exactly 7 TPS (by design)",
      "About 100 TPS with SegWit"
    ],
    "answer": 0,
    "explanation": "Bitcoin's base layer handles roughly 3–7 transactions per second on average. The Lightning Network, by contrast, can process millions of transactions per second off-chain."
  },
  {
    "q": "Where is an obituary for cypherpunk Len Sassaman permanently stored?",
    "options": [
      "Embedded in every Bitcoin node as a transaction on the timechain",
      "In the Bitcoin whitepaper's references section",
      "In block 0 alongside the genesis block headline",
      "In the Bitcoin Core repository README file"
    ],
    "answer": 0,
    "explanation": "An obituary for Len Sassaman — a cypherpunk who had direct impact on Bitcoin's creation — is embedded on the Bitcoin timechain and thus stored in every full node. Many believe he may have been Satoshi Nakamoto."
  },
  {
    "q": "How many halvings align between Bitcoin's halving cycle (every 210,000 blocks) and its difficulty epoch (every 2,016 blocks)?",
    "options": [
      "Every 1,260,000th block (every ~24 years)",
      "Every block — they always align",
      "Every 21,000th block",
      "They never align precisely"
    ],
    "answer": 0,
    "explanation": "Bitcoin halvings (every 210,000 blocks) and difficulty epochs (every 2,016 blocks) align every 1,260,000th block — approximately every 24 years. The math: LCM(210,000, 2,016) = 1,260,000."
  },
  {
    "q": "What was the Bitaxe solo miner's estimated probability of finding a block in July 2024?",
    "options": [
      "1 in 3,500 years (which it actually did)",
      "1 in 10 days",
      "1 in 1,000 years",
      "1 in 21 million"
    ],
    "answer": 0,
    "explanation": "In July 2024, a Bitaxe home miner with just 3 TH/s successfully found a Bitcoin block — an event with roughly a 1-in-3,500-year statistical probability. One of Bitcoin's most celebrated solo mining moments."
  }
];
