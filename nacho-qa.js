...
{ keys: ['what is hodl','hodl','hodl meaning','why hodl','hodling'],
  answer: "HODL originated from a legendary 2013 Bitcoin Talk forum post where a user misspelled 'hold' while drunk during a price crash! 🍺🦌 The typo stuck and became Bitcoin's most famous meme. It stands for 'Hold On for Dear Life' (backronym). HODLing means buying Bitcoin and holding it long-term through all the volatility — crashes, FUD, and all. The philosophy: Bitcoin's long-term trend is up, so selling during dips means missing the recovery. Diamond hands! 💎🙌",
  channel: 'investment-strategy', channelName: 'Investment Strategy' },
