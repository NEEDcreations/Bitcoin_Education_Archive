...
const NACHO_ITEMS = [
    ...
    { id: 'orange_scarf', category: 'shirt', name: 'Bitcoin Scarf', emoji: '🧣', desc: 'A cozy orange scarf with the ₿ symbol.', level: 1, overlay: { top: '68%', left: '50.5%', transform: 'translateX(-50%)', fontSize: '1.8em' }, hidden: false, colorable: true },
    { id: 'sunglasses', category: 'glasses', name: 'Cool Shades', emoji: '🕶️', desc: 'Sunglasses so cool, even the blockchain can\'t see through them.', level: 1, overlay: { top: '43%', left: '50%', transform: 'translateX(-50%)', fontSize: '1.4em' }, hidden: false },
    { id: 'bowtie', category: 'shirt', name: 'Fancy Bowtie', emoji: '🎀', desc: 'A dapper bowtie for a distinguished buck. Class and sats.', level: 1, overlay: { top: '64%', left: '50%', transform: 'translateX(-50%)', fontSize: '1.3em' }, hidden: false, colorable: true },

    // Level 2 — Getting Acquainted (10+ interactions)
    { id: 'mining_helmet', category: 'hat', name: 'Mining Helmet', emoji: '⛑️', desc: 'A safety helmet for a hardworking miner. Ready to find the next block!', level: 2, overlay: { top: '5%', left: '50%', transform: 'translateX(-50%)', fontSize: '2.2em' }, hidden: false },
    ...
    { id: 'party_hat', category: 'hat', name: 'Party Hat', emoji: '🎉', desc: 'Every day is a party when you\'re stacking sats!', level: 2, overlay: { top: '2%', left: '58%', transform: 'translateX(-50%) rotate(15deg)', fontSize: '1.8em' }, hidden: false, colorable: true },

    // Level 3 — Good Friends (25+ interactions)
    { id: 'hodl_hoodie', category: 'shirt', name: 'HODL Hoodie', emoji: '🧥', desc: 'A hoodie that says HODL on the back. For diamond-handed deer.', level: 3, overlay: { top: '72%', left: '50%', transform: 'translateX(-50%)', fontSize: '2.2em' }, hidden: false, colorable: true },
    { id: 'laser_eyes', category: 'glasses', name: 'Laser Eyes', emoji: '🔴', desc: 'The legendary Bitcoin laser eyes. Number go up!', level: 3, overlay: { top: '43%', left: '50.5%', transform: 'translateX(-50%)', fontSize: '0.9em', custom: '🔴  🔴' }, hidden: false },
    { id: 'wizard_hat', category: 'hat', name: 'Wizard Hat', emoji: '🪄', desc: 'A mystical wizard hat. Nacho casts spells of financial sovereignty!', level: 3, overlay: { top: '-5%', left: '50%', transform: 'translateX(-50%)', fontSize: '2.4em' }, hidden: false, colorable: true },
    { id: 'crown', category: 'hat', name: 'Royal Crown', emoji: '👑', desc: 'Fit for the king of cryptocurrency. There is no second best!', level: 3, overlay: { top: '3%', left: '50%', transform: 'translateX(-50%)', fontSize: '2.2em' }, hidden: false },
    ...
    { id: 'rainbow_antlers', category: 'hat', name: '???', emoji: '🌈', desc: 'Reach Best Buds friendship to reveal this item!', level: 5, overlay: { top: '2%', left: '50%', transform: 'translateX(-50%)', fontSize: '2.8em' }, hidden: true, revealName: 'Rainbow Antlers', revealEmoji: '🌈', revealDesc: 'Prismatic rainbow antlers that shimmer in every color. Legendary!' },

    // Secret — Easter egg only
    { id: 'bitcoin_eyes', category: 'glasses', name: '???', emoji: '₿', desc: 'How do you find this one?', level: 1, overlay: { top: '43%', left: '50.5%', transform: 'translateX(-50%)', fontSize: '1.2em', custom: '₿  ₿' }, hidden: true, revealName: 'Bitcoin Eyes', revealEmoji: '₿', revealDesc: 'Eyes made of pure Bitcoin. You found the secret! Nacho sees everything in sats now.' },

    // Seasonal — toggled via localStorage
    { id: 'santa_hat', category: 'hat', name: 'Santa Hat', emoji: '🎅', desc: 'Ho ho HODL! A festive Santa hat for the holiday season.', level: 1, overlay: { top: '1%', left: '54%', transform: 'translateX(-50%) rotate(15deg)', fontSize: '2.2em' }, hidden: false, seasonal: 'december' },
    { id: 'pumpkin', category: 'hat', name: 'Pumpkin Head', emoji: '🎃', desc: 'Spooky season! A jack-o-lantern for Halloween.', level: 1, overlay: { top: '8%', left: '50%', transform: 'translateX(-50%)', fontSize: '2.8em' }, hidden: false, seasonal: 'october' },
