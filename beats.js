...
window.beatsEnsureGlobalPlayer = function() {
    ...
    if (!document.getElementById('beatsMiniPlayerCSS')) {
        ...
        mcss.textContent = '@media(min-width:901px){#beatsMiniPlayer{bottom:12px!important;left:260px!important;}}#beatsMiniPlayer:hover{transform:scale(1.05);}';
