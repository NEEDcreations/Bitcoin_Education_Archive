    ...
    <div id="beatsApp" style="max-width:900px;margin:20px auto;padding:0 16px;animation:fadeSlideIn 0.4s ease-out;">
        ...
        <div style="display:flex;align-items:center;gap:16px;margin-bottom:24px;">
            <div class="channel-logos" style="display:flex;gap:12px;align-items:center;">
                <img src="https://assets.bitcoineducation.quest/images/btc-grad-logo-sm.jpg" alt="Home" class="channel-logo-img" onclick="goHome()" style="width:44px;height:44px;border-radius:50%;cursor:pointer;box-shadow:0 0 12px rgba(247,147,26,0.3);object-fit:cover;" title="Home">
                ...
                db.collection('users').doc(uid).get().then(function(udoc) {
                    ...
                    appBody.innerHTML =
                        ...
                        '<div style="display:grid;grid-template-columns:repeat(3,1fr);gap:8px;margin-bottom:16px;">' +
                            ...
                            '<div style="text-align:center;padding:10px;background:var(--card-bg);border:1px solid var(--border);border-radius:10px;"><div style="font-weight:900;color:var(--heading);">' + (ud.channelsVisited || 0) + '</div><div style="color:var(--text-faint);font-size:0.65rem;">Topics</div></div>' +
