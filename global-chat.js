...
function createChatOverlay() {
    ...
    btn.innerHTML = '💬';
    btn.title = 'Open Chat';
    btn.style.cssText = 'position:fixed;bottom:calc(70px + env(safe-area-inset-bottom,0px));right:72px;z-index:300;width:48px;height:48px;border-radius:50%;background:var(--accent,#f7931a);color:#fff;border:none;font-size:1.4rem;cursor:pointer;box-shadow:0 4px 16px rgba(0,0,0,0.4);transition:transform 0.2s,opacity 0.2s;touch-action:manipulation;-webkit-tap-highlight-color:transparent;';
