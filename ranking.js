...
async function signInWithApple() {
    await signInWithProvider(new firebase.auth.OAuthProvider('apple.com'));
}
...
function showSignInPrompt() {
    ...
    box.innerHTML = '<h2>👋 Welcome Back!</h2>' +
        ...
        '<button onclick="signInWithApple()" style="width:100%;padding:12px;background:var(--card-bg);border:1px solid var(--border);border-radius:10px;color:var(--text);font-size:0.9rem;cursor:pointer;font-family:inherit;display:flex;align-items:center;justify-content:center;gap:8px;"> Apple</button>' +
        '</div>' +
