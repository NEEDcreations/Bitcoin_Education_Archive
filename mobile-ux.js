...
function initBottomNav() {
    ...
    nav.innerHTML =
        '<div style="display:flex;justify-content:space-around;align-items:stretch;max-width:500px;margin:0 auto;">' +
            '<button onclick="if(typeof hideUsernamePrompt===\'function\'){var _m=document.getElementById(\'usernameModal\');if(_m&&_m.classList.contains(\'open\'))hideUsernamePrompt();}goHome()" class="bnav-btn" id="bnavHome"><span class="bnav-icon">🏠</span><span class="bnav-label">Home</span></button>' +
