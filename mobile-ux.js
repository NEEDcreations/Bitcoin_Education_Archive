...
window.toggleMobileLearnMenu = function() {
    ...
    menu.innerHTML =
        ...
        '<div style="display:flex;flex-direction:column;gap:8px;">' +
            ...
            '<button onclick="document.getElementById(\'mobileLearnMenu\').remove();setTimeout(function(){if(typeof showQuestHub===\'function\')showQuestHub()},200)" style="padding:12px 14px;background:linear-gradient(135deg,rgba(139,92,246,0.15),rgba(109,40,217,0.08));border:1px solid #8b5cf6;color:#a78bfa;border-radius:12px;font-weight:800;cursor:pointer;font-size:0.88rem;text-align:left;font-family:inherit;touch-action:manipulation;display:flex;align-items:center;gap:8px;">🎯 Daily Quests</button>' +
