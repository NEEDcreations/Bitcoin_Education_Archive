...
function initTicker() {
    ...
    function refreshSignalNews() {
        ...
        fetch(proxy + '?q=' + encodeURIComponent('Bitcoin only news BTC price mining lightning network 2026 -ethereum -crypto -altcoin -2024'), { signal: AbortSignal.timeout(8000) })
